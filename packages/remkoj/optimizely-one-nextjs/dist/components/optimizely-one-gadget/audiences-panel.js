...
export const AudiencesPanel = ({ servicePrefix = '/api/me', refreshInterval = 0 }) => {
    ...
    // Show list
    return _jsxs(_Fragment, { children: [_jsxs("p", { className: 'oo-font-bold', children: ["Audiences", (isValidating && !isLoading) && _jsx(ArrowPathIcon, { className: 'oo-inline-block oo-h-4 oo-w-4 oo-ml-2 oo-animate-spin' })] }), hasMore && _jsxs("p", { className: 'oo-text-xs oo-border oo-border-amber-800 oo-bg-amber-200 oo-text-amber-800 oo-p-1 oo-my-1 oo-rounded-md', children: ["Showing results for the first ", size * pageSize, " audiences of ", audienceCount, ", ", _jsx("span", { onClick: () => setSize(size + 1), className: "oo-cursor-pointer oo-underline oo-text-blue-800", children: "load more" })] }), isLoading && _jsxs("p", { className: 'oo-m-2 md:oo-m-4 oo-rounded-md oo-bg-amber-200 oo-border oo-border-amber-800 oo-text-amber-800 oo-p-1 md:oo-p-2', children: [_jsx(ArrowPathIcon, { className: 'oo-inline-block oo-h-4 oo-w-4 oo-mr-2 oo-animate-spin' }), "Loading the audiences..."] }), _jsx("ul", { className: `oo-text-sm oo-grid oo-grid-cols-1 oo-divide-y`.trimEnd(), children: (profiles || []).map(profile => (profile?.audiences ?? []).map(a => {
                ...
                })).flat() }), hasMore && _jsx("p", { onClick: () => setSize(size + 1), className: 'oo-text-center oo-inline-block oo-cursor-pointer oo-px-2 oo-py-1 oo-border oo-border-b-0 oo-border-slate-300 oo-rounded-md oo-bg-blue-500 oo-text-white', children: "Load more" })] });
};
