...
export const OptimizelyOneGadget : FunctionComponent<OptimizelyOneGadgetProps> = ({ servicePrefix = "/api/me", refreshInterval = 0, show = undefined }) =>
{
    ...
    return <Popover className="oo-gadget oo-h-10 md:oo-fixed md:oo-bottom-0">
        <Popover.Button className='oo-fixed oo-bottom-0 oo-right-0 oo-w-full oo-h-10 oo-flex oo-flex-row oo-justify-between oo-p-2 oo-border-t oo-border-slate-500 oo-bg-slate-100 oo-text-slate-800 md:oo-w-80 md:oo-right-4 md:oo-rounded-t-md md:oo-border-x'>
        ...
        <Popover.Panel className="oo-fixed oo-bottom-10 oo-right-0 oo-w-full oo-top-0 md:oo-border md:oo-border-slate-300 oo-bg-white md:oo-right-4 md:oo-bottom-12 md:oo-w-[42rem] oo-z-[10000] oo-max-w-full oo-flex oo-flex-col oo-justify-stretch md:oo-h-80 md:oo-top-auto md:oo-rounded-md md:oo-shadow-xl md:oo-overflow-hidden">
            <div className="oo-border-b oo-border-slate-300 oo-bg-slate-100 oo-text-slate-800 oo-font-bold oo-p-1 oo-flex-none md:oo-p-2"><IdentificationIcon className='oo-inline-block oo-h-6 oo-w-6 oo-mr-2' />My Profile</div>
            <Tab.Group>
                <Tab.List className="oo-flex-none oo-flex oo-justify-between md:oo-justify-start oo-gap-2 oo-p-1 md:oo-p-2 oo-pb-0 md:oo-pb-0 oo-border-b oo-border-slate-300 oo-text-sm">
                    <Tab as="div" className='oo-text-center oo-inline-block oo-cursor-pointer oo-px-2 oo-py-1 oo-border oo-border-b-0 oo-border-slate-300 oo-rounded-t-md oo-ui-selected:oo-bg-blue-500 oo-ui-selected:oo-text-white'><TagIcon className='oo-inline-block oo-h-4 oo-w-4 oo-mr-2' />Interests</Tab>
