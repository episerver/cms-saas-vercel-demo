...
export declare function extractPluginConfigAndApplyDefaults(baseConfig: Record<string, any>, defaultValues: Partial<OptimizelyFunctionOptions>): Partial<OptimizelyFunctionOptions>;
