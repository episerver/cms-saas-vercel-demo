...
export const TestimonialElementElement : CmsComponent<TestimonialElementDataFragment> = ({ 
    ...
    return <CmsEditable as="figure" className='testimonial' cmsId={ key } ctx={ ctx }>
        ...
        <figcaption>
            <cite className="ml-0 mt-4 lg:flex lg:justify-start lg:items-center not-italic">
                ...
                { customerLocation && <>
                    ...
                    <CmsEditable as="p" cmsFieldName="customerLocation" className="my-0" ctx={ctx}>{ customerLocation }</CmsEditable>
                </> }
            </cite>
        </figcaption>
    </CmsEditable>
