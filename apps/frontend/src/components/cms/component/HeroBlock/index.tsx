...
import { EditableHeroWrapper } from "@/components/admin";
...
export const HeroBlockComponent: CmsComponent<HeroBlockDataFragment> = ({
  ...
  // Extract plain text description for the editable wrapper
  const descriptionText = description?.html || "";

  return (
    <EditableHeroWrapper
      contentKey={contentLink.key ?? null}
