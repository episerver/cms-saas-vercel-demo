...
export const MegaMenuGroupBlockComponent : CmsComponent<MegaMenuGroupBlockDataFragment> = ({ data, ctx }) => {
    ...
    return <Popover>
        <CmsEditable as={PopoverButton} cmsFieldName="MenuMenuHeading" data-menu-label={menuName} className="px-2 xl:px-4 h-full align-bottom hover:text-azure focus:text-azure font-semibold dark:text-white dark:focus:text-verdansk dark:hover:text-verdansk">
            { menuName }
        </CmsEditable>
