...
import CardBlock from "@/components/block/card-block/card-block";
...
export default function SavingsPage() {
  return (
    <>
      ...
      >
        <TextBlock
          overline="More than competitive"
          heading="4.8%* APY"
          headingSize={"extraLarge"}
          description="<p>Make your money make money.</p>"
          center={true}
        ></TextBlock>
      </ContainerBlock>
      <ContainerBlock
      ...
      >
        <CardBlock
          ...
          image={{
            src: "https://placekitten.com/650/440",
            alt: "Kitten",
            width: 650,
            height: 440,
          }}
      ...
      >
        <CardBlock
          ...
          description={
            "<p>With our high-yield savings account, your money only goes down if you take it out. HySavings is fee-free forever.</p>"
          }
          image={{
            src: "https://placekitten.com/650/440",
            alt: "Kitten",
      ...
      >
        <CardBlock
          ...
          description={
            "<p>Rest easy knowing your savings are FDIC insured, offering you the security and peace of mind you deserve.</p>"
          }
          color={"white"}
        />
        <CardBlock
