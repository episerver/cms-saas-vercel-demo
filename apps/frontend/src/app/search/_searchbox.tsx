...
export const SearchBox: FunctionComponent<SearchBoxProps> = ({
    ...
    return <div className="search-box-container py-[40px]">
        <div className="search-box border-solid border-[2px] h-[56px] w-full max-w-[33%] rounded-[20px] bg-ghost-white dark:bg-vulcan z-[999] border-azure dark:border-verdansk flex flex-row justify-stretch content-stretch">
